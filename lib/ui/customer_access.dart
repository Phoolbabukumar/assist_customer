...
class CustomerAccessScreen extends StatelessWidget {
  final HomeScreenController hsc;
  const CustomerAccessScreen({super.key, required this.hsc});
              ...
              child: SingleChildScrollView(
                child: Column(
                  ...
                  children: [
                    ...
                    customText(
                      text: haveQueryContactToSupport,
                      size: 18,
                      textAlign: TextAlign.center,
                    ),
                    SizedBox(
