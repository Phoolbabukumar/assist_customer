class MembershipListResponse {
  List<MembershipListModel>? response = [];

  MembershipListResponse({this.response});

  MembershipListResponse.fromJson(Map<String, dynamic> json) {
    if (json['membershipDetails'] != null) {
      json['membershipDetails'].forEach((v) {
        response!.add(MembershipListModel.fromJson(v));
      });
    } else {
      response!.add(MembershipListModel.fromJson(json));
    }
  }
}
...
class MembershipListModel {
  ...
  MembershipListModel.fromJson(Map<String, dynamic> json) {
    ...
    otherVehicleType = json.containsKey('otherVehicleType') ? json['otherVehicleType'] : "";
  }
}
